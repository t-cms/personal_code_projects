...
ggplot(general_grouped_eligible, aes(x = race, y = count_eligible, fill = sex)) +
...
# Plot: Eligible counts by race and sex with angled x-axis
ggplot(mechanical_grouped_eligible, aes(x = race, y = count_eligible, fill = sex)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(
...
# Plot: Eligible counts by race and sex with angled x-axis
ggplot(admin_grouped_eligible, aes(x = race, y = count_eligible, fill = sex)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(
...
```{r}
# Plot: Eligible counts by race and sex with angled x-axis
ggplot(electronics_grouped_eligible, aes(x = race, y = count_eligible, fill = sex)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(
